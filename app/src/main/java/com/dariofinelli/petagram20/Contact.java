...
import com.dariofinelli.petagram20.javamail.JavaMailAPI;
...
public class Contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputLayoutFullName = findViewById(R.id.tilFullName);
        textInputLayoutEmail = findViewById(R.id.tilEmail);
        textInputLayoutComment = findViewById(R.id.tilComment);
    }
